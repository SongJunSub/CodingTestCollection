...
public class MemoriesScore {
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new MemoriesScore().solution(new String[]{"may", "kein", "kain", "radi"}, new int[]{5, 10, 1, 3},
                new String[][]{{"may", "kein", "kain", "radi"}, {"may", "kein", "brin", "deny"}, {"kon", "kain", "may", "coni"}})));
        System.out.println(Arrays.toString(new MemoriesScore().solution(new String[]{"kali", "mari", "don"}, new int[]{11, 1, 55},
