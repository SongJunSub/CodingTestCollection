...
public class TemplarsWeapon {
    ...
    public int betterSolution(int number, int limit, int power) {
        int answer = 0;
    ...
    public static void main(String[] args) {
        System.out.println(new TemplarsWeapon().solution(5, 3, 2));
        System.out.println(new TemplarsWeapon().solution(10, 3, 2));

        System.out.println(new TemplarsWeapon().betterSolution(5, 3, 2));
        System.out.println(new TemplarsWeapon().betterSolution(10, 3, 2));
    }
